...
def get_hit_metrics(job_dir, iter_max=10, task_col='pcba-aid624173', cluster_col='BT_0.4 ID', summary_iter_num=9999):
    ...
    job_df['iter_num'] = list(np.arange(iter_max)) + [summary_iter_num]
