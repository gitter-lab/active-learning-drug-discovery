"""
    ...
    Usage:
        ...
        --hyperparams_json_file=../param_configs/first_pass_hyperparams/ClusterBasedWCSelector_104.json \
        --initial_dataset_file=../datasets/lc_clusters_cv_96/unlabeled_33.csv
        --iter_max=5 \ 
        --batch_size_index=0 \
...
if __name__ ==  '__main__':
    ...
    pipeline_config['common']['params_set_results_dir'] = "../params_results/{}/{}/"
    rnd_seed = next_batch_selector_params['rnd_seed']
    
    params_set_results_dir = pipeline_config['common']['params_set_results_dir'].format(next_batch_selector_params['hyperparameter_id'],
